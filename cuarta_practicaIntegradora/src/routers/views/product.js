...
ViewProductRouter.get("/create",isAuthenticated,authorize([ROLES.admin,ROLES.premiun]), ViewProducts.renderProductForm);
ViewProductRouter.get("/edit/:pid",isAuthenticated, authorize([ROLES.admin,ROLES.premiun]), ViewProducts.renderProductForm);
